<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="StockStatic.ascx.vb" Inherits="EISTest.StockStatic" %>
<style type="text/css">
    .auto-style1
    {
        width: 81px;
...
<asp:ObjectDataSource ID="odsSearchResult" runat="server" SelectMethod="Search1" TypeName="EISTest.StockStatic">
    <SelectParameters>
