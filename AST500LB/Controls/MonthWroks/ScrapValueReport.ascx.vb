...
#Region "查詢 方法:Search"
    ...
    Public Shared Function Search(ByVal QryString As String) As AST500LB.AST500LBDataSet.ScrapValueReportDataTable
        Dim ReturnValue = New AST500LB.AST500LBDataSet.ScrapValueReportDataTable
        If String.IsNullOrEmpty(QryString) Then
            Return ReturnValue
        End If
        For EachCount = 1 To 70
            Dim AddItem As AST500LB.AST500LBDataSet.ScrapValueReportRow = ReturnValue.NewRow
            With AddItem
                .財產統一編號 = IIf(EachCount Mod 2 = 1, "1", "2")
            End With
