...
#Region "查詢 方法:Search"
    ...
    Public Shared Function Search(ByVal QryString As String) As AST500LB.AST500LBDataSet.FAMDepReportDataTable
        Dim ReturnValue = New AST500LB.AST500LBDataSet.FAMDepReportDataTable
        If String.IsNullOrEmpty(QryString) Then
            Return ReturnValue
        End If
        For EachCount = 1 To 70
            Dim AddItem As AST500LB.AST500LBDataSet.FAMDepReportRow = ReturnValue.NewRow
            With AddItem
