<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="AddDeleteReport.ascx.vb" Inherits="AST500LB.AddDeleteReport" %>
...
<%--<rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"  InteractiveDeviceInfos="(集合)" Height="614px"  WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%">
    <LocalReport ReportPath="Controls\MonthWroks\AddDeleteReport.rdlc">
        <DataSources>
