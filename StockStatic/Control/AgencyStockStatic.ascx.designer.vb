...
Partial Public Class AgencyStockStatic
    ...
    '''<summary>
    '''tbConvertToExcel 控制項。
    '''</summary>
    '''<remarks>
    '''自動產生的欄位。
    '''將移動欄位宣告從設計檔案修改為程式碼後置檔案。
    '''</remarks>
    Protected WithEvents tbConvertToExcel As Global.System.Web.UI.WebControls.Button
    ...
    '''將移動欄位宣告從設計檔案修改為程式碼後置檔案。
    '''</remarks>
    Protected WithEvents hfCCMQry As Global.System.Web.UI.WebControls.HiddenField
    ...
    '''將移動欄位宣告從設計檔案修改為程式碼後置檔案。
    '''</remarks>
    Protected WithEvents hfSGMQry As Global.System.Web.UI.WebControls.HiddenField
