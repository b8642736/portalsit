<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WebClientPCAuthorityEdit.ascx.vb" Inherits="WebAppAuthority.WebClientPCAuthorityEdit" %>
<%@ Register src="EmployeeSearch.ascx" tagname="employeesearch" tagprefix="uc1" %>
<%@ Register src="ClientPCSearch.ascx" tagname="ClientPCSearch" tagprefix="uc2" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <uc2:ClientPCSearch ID="ClientPCSearch1" runat="server" />
    </ContentTemplate>
</asp:UpdatePanel>
