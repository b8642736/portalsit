...
Public Class CCMailExcute_Main
    Inherits System.Web.UI.UserControl
    Dim WP_ClsSystemNote As New PublicClassLibrary.ClsSystemNote
    Dim WP_System_Type As String = "CCMail"
    Dim dot_NOTE_Type As String = "同步與編輯人員"


    Private Sub P_reFresh父物件(from主畫面_ActiveTabIndex As 主畫面_Enum) Handles CCMailExcute_Synchronize1.Event_reFresh父物件

        TabContainer1.ActiveTabIndex = from主畫面_ActiveTabIndex

        Select Case from主畫面_ActiveTabIndex
            Case 主畫面_Enum.編修
                CCMailExcute_Synchronize1.P_reFresh子物件(WP_LoginUserUnit, WP_LoginUserID)
        End Select
