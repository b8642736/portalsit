<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CCMailExcute_Synchronize.ascx.vb" Inherits="WebAppAuthority.CCMailExcute_Synchronize" %>
...
<p>
    同步400(SPAM資料將於整點自動同步)<br />
    <br />
    <asp:Button ID="btSynchronize" runat="server" Text="同步" Height="29px" Width="79px" />
</p>
<p>
            <asp:Button ID="btnSearch" runat="server" Height="27px" Text="更新頁面" Width="73px" />


            <asp:ObjectDataSource ID="odsSearch" runat="server" SelectMethod="Search" TypeName="WebAppAuthority.CCMailExcute_Synchronize" UpdateMethod="Update">
                <SelectParameters>
...
<asp:ListView ID="ListView1" runat="server" DataSourceID="odsSearch" EnableModelValidation="True">
    <AlternatingItemTemplate>
        <tr style="background-color:#FFF8DC;">
            ...
            <td>
                <asp:Label ID="executeDateLabel" runat="server" Text='<%# FS_OnlyDate(Eval("executeDate"))%>' />
            </td>
    ...
    <EditItemTemplate>
        <tr style="background-color:#008A8C;color: #FFFFFF;">
            ...
            <td>
                <asp:TextBox ID="sequence_XMLTextBox" runat="server" Text='<%# Bind("sequence_XML") %>' />
            </td>
            <td>
...
<p>
    ...
    Message <asp:button ID="btn_clear_msg" runat="server" Text="清除"></asp:button><br />
...
<asp:TextBox ID="tb_result" runat="server" Height="168px" TextMode="MultiLine" Width="620px" ReadOnly="True"></asp:TextBox>
