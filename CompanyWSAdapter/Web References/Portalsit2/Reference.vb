...
'
'原始程式碼已由 Microsoft.VSDesigner 自動產生，版本 2.0.50727.3074。
'
Namespace Portalsit2
    ...
    Partial Public Class WSDBSQLQuery
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.CompanyWSAdapter.My.MySettings.Default.CompanyWSAdapter_Portalsit2_WSDBSQLQuery
        ...
        Public Function SQLServerSelectQuery(ByVal SetSourceQueryString As String, ByVal SetSQLServerIPOrName As String, ByVal SetConnectDBName As String, ByVal AcceptCodeReplay As String) As System.Data.DataTable
            Dim results() As Object = Me.Invoke("SQLServerSelectQuery", New Object() {SetSourceQueryString, SetSQLServerIPOrName, SetConnectDBName, AcceptCodeReplay})
            Return CType(results(0),System.Data.DataTable)
        End Function
        
        '''<remarks/>
        Public Overloads Sub SQLServerSelectQueryAsync(ByVal SetSourceQueryString As String, ByVal SetSQLServerIPOrName As String, ByVal SetConnectDBName As String, ByVal AcceptCodeReplay As String)
            Me.SQLServerSelectQueryAsync(SetSourceQueryString, SetSQLServerIPOrName, SetConnectDBName, AcceptCodeReplay, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub SQLServerSelectQueryAsync(ByVal SetSourceQueryString As String, ByVal SetSQLServerIPOrName As String, ByVal SetConnectDBName As String, ByVal AcceptCodeReplay As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("SQLServerSelectQuery", New Object() {SetSourceQueryString, SetSQLServerIPOrName, SetConnectDBName, AcceptCodeReplay}, Me.SQLServerSelectQueryOperationCompleted, userState)
        End Sub
        ...
        Public Function SQLServerExecuteNonQuery(ByVal SetSourceQueryString As String, ByVal SetSQLServerIPOrName As String, ByVal SetConnectDBName As String, ByVal AcceptCodeReplay As String) As Integer
            Dim results() As Object = Me.Invoke("SQLServerExecuteNonQuery", New Object() {SetSourceQueryString, SetSQLServerIPOrName, SetConnectDBName, AcceptCodeReplay})
            Return CType(results(0),Integer)
        End Function
        
        '''<remarks/>
        Public Overloads Sub SQLServerExecuteNonQueryAsync(ByVal SetSourceQueryString As String, ByVal SetSQLServerIPOrName As String, ByVal SetConnectDBName As String, ByVal AcceptCodeReplay As String)
            Me.SQLServerExecuteNonQueryAsync(SetSourceQueryString, SetSQLServerIPOrName, SetConnectDBName, AcceptCodeReplay, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub SQLServerExecuteNonQueryAsync(ByVal SetSourceQueryString As String, ByVal SetSQLServerIPOrName As String, ByVal SetConnectDBName As String, ByVal AcceptCodeReplay As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("SQLServerExecuteNonQuery", New Object() {SetSourceQueryString, SetSQLServerIPOrName, SetConnectDBName, AcceptCodeReplay}, Me.SQLServerExecuteNonQueryOperationCompleted, userState)
        End Sub
