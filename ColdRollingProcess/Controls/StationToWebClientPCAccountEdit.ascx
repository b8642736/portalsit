<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="StationToWebClientPCAccountEdit.ascx.vb" Inherits="ColdRollingProcess.StationToWebClientPCAccountEdit" %>
<style type="text/css">
    ...
    <tr>
        <td>
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                EnableModelValidation="True" PageSize="16" style="margin-right: 0px" 
            ...
            <asp:ObjectDataSource ID="odsSearchResult1" runat="server" 
                ...
                TypeName="ColdRollingProcess.StationToWebClientPCAccountEdit">
                <SelectParameters>
                    <asp:ControlParameter ControlID="hfQryString1" Name="QryString" 
                        PropertyName="Value" Type="String" />
                    <asp:SessionParameter Name="CurrentStationID" SessionField="_StationName" 
                        Type="String" />
                </SelectParameters>
        ...
        <td>
            <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                ...
                EnableModelValidation="True" PageSize="16" DataKeyNames="ClientIP">
                <Columns>
            ...
            <asp:ObjectDataSource ID="odsSearchResult2" runat="server" 
                ...
                <SelectParameters>
                    <asp:ControlParameter ControlID="hfQryString2" Name="QryString" 
                        PropertyName="Value" Type="String" />
                    <asp:SessionParameter Name="CurrentStationID" 
                        SessionField="_StationName" Type="String" />
                </SelectParameters>
            </asp:ObjectDataSource>
        </td>
    </tr>
