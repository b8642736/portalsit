...
#Region "澆鑄日期轉日期格式 SGA07DateType"
        ...
        ReadOnly Property SGA07DateType() As DateTime
            Get
                Dim GetDateString As String = Me.SGA07.ToString
                Dim GetYear As String = CType(CType(GetDateString.Substring(0, 2), Integer) + 1911, String)
                Dim GetMonth As String = GetDateString.Substring(2, 2)
                Dim GetDate As String = GetDateString.Substring(4, 2)
                Return New Date(CType(GetYear, Integer), CType(GetMonth, Integer), CType(GetDate, Integer))
            End Get
        End Property
#End Region
