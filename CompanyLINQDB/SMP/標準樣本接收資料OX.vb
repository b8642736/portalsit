    ...
    Public Property DataDisplayMode() As DataDisplayModeEnum
        ...
        Set(ByVal value As DataDisplayModeEnum)
            ...
            If _DataDisplayMode = DataDisplayModeEnum.ForCheckMode Then
                ...
                End If
                If Not IsNothing(RangeData.UP_N2) AndAlso Me.N1 > RangeData.UP_N2 Then
                    Me.N1 = RangeData.UP_N2
                End If
                If Not IsNothing(RangeData.Down_N2) AndAlso Me.N1 < RangeData.Down_N2 Then
                    Me.N1 = RangeData.Down_N2
                End If
                If Not IsNothing(RangeData.UP_O2) AndAlso Me.N1 > RangeData.UP_O2 Then
                    Me.N1 = RangeData.UP_O2
                End If
                If Not IsNothing(RangeData.Down_O2) AndAlso Me.N1 < RangeData.Down_O2 Then
                    Me.N1 = RangeData.Down_O2
                End If
            End If
        End Set
    End Property
