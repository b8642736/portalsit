Public Class DebtLetterofCreditSearch
    ...
    Public Sub P_Init()
        ...
        tbToday_Start.Text = (DateAdd(DateInterval.Month, -2, Now).ToString("yyyy/MM/dd"))
...
#Region "查詢 方法:Search"
    ...
    Public Function Search(ByVal fromSQL As String, ByVal fromParam As String) As FinancialDataSet.DebtLetterofCreditSearchDataTable
        Dim retTable As New FinancialDataSet.DebtLetterofCreditSearchDataTable
        Dim addItem As FinancialDataSet.DebtLetterofCreditSearchRow
