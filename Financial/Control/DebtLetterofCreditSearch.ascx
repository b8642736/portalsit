<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="DebtLetterofCreditSearch.ascx.vb" Inherits="Financial.DebtLetterofCreditSearch" %>
...
<table class="auto-style1">
    ...
    <tr>
        ...
        <td>
            ...
            <asp:ObjectDataSource ID="odsSearchResult" runat="server" SelectMethod="Search" TypeName="Financial.DebtLetterofCreditSearch">
                <SelectParameters>
...
<asp:ListView ID="ListView1" runat="server" DataSourceID="odsSearchResult" EnableModelValidation="True">
    ...
    <ItemTemplate>
        <tr style="background-color: #DCDCDC; color: #000000;">
            <td>
                <asp:Label ID="到期日Label" runat="server" Text='<%# Eval("到期日") & ModTools.showSpace(2)%>' />
            </td>
            <td>
                <asp:Label ID="信用狀編號Label" runat="server" Text='<%# Eval("信用狀編號") & ModTools.showSpace(2)%>' />
            </td>
            <td>
                <asp:Label ID="單位別Label" runat="server" Text='<%# Eval("單位別") & ModTools.showSpace(2)%>' />
            </td>
            <td>
                <asp:Label ID="幣別Label" runat="server" Text='<%# Eval("幣別") & ModTools.showSpace(2)%>' />
            </td>
            <td>
                <asp:Label ID="金額Label" runat="server" Text='<%# Eval("金額") & ModTools.showSpace(2)%>' />
            </td>
            <td>
                <asp:Label ID="發行日Label" runat="server" Text='<%# Eval("發行日") & ModTools.showSpace(2)%>' />
            </td>
            <td>
                <asp:Label ID="銀行別Label" runat="server" Text='<%# Eval("銀行別") & ModTools.showSpace(2)%>' />
            </td>
            <td>
                <asp:Label ID="期限Label" runat="server" Text='<%# Eval("期限") & ModTools.showSpace(2)%>' />
            </td>
            <td>
                <asp:Label ID="利率Label" runat="server" Text='<%# Eval("利率") & ModTools.showSpace(2)%>' />
            </td>
            <td>
                <asp:Label ID="利息Label" runat="server" Text='<%# Eval("利息") & ModTools.showSpace(2)%>' />
            </td>
            <td>
                <asp:Label ID="兌換率Label" runat="server" Text='<%# Eval("兌換率") & ModTools.showSpace(2)%>' />
            </td>
            <td>
                <asp:Label ID="新台幣金額Label" runat="server" Text='<%# Eval("新台幣金額") & ModTools.showSpace(2)%>' />
            </td>
        </tr>
    </ItemTemplate>
    <LayoutTemplate>
