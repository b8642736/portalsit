<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="StandardSampleOXReceiveEdit.ascx.vb" Inherits="SMP.StandardSampleOXReceiveEdit" %>
...
<table class="auto-style1">
    ...
    <tr>
        ...
        <td>
            ...
            <asp:ObjectDataSource ID="odsSearchResult" runat="server" DataObjectTypeName="CompanyORMDB.SQLServer.QCDB01.標準樣本接收資料OX" SelectMethod="Search" TypeName="SMP.StandardSampleOXReceiveEdit" UpdateMethod="CDBUpdate" DeleteMethod="CDBDelete">
                <SelectParameters>
    ...
    <AlternatingItemTemplate>
        <tr style="background-color: #FFF8DC;">
            ...
            <td>
                ...
                <asp:HiddenField ID="hfShowSampleID" runat="server" Value='<%# Eval("ShowSampleID") %>' />
            ...
            <td>
                <asp:Label ID="MachineIDLabel" runat="server" Text='<%# Eval("MachineID") %>' />
            </td>
            <td>
    ...
    <EditItemTemplate>
        <tr style="background-color: #008A8C; color: #FFFFFF;">
            ...
            <td>
                ...
                <asp:HiddenField ID="hfShowSampleID" runat="server" Value='<%# Bind("ShowSampleID") %>' />
            ...
            <td>
                <asp:Label ID="MachineIDLabel" runat="server" Text='<%# Bind("MachineID")%>' />
            </td>
            <td>
                ...
                <td id="Td1" runat="server">
                    <table id="itemPlaceholderContainer" runat="server" border="1" style="background-color: #FFFFFF; border-collapse: collapse; border-color: #999999; border-style: none; border-width: 1px; font-family: Verdana, Arial, Helvetica, sans-serif;">
                        <tr id="Tr2" runat="server" style="background-color: #DCDCDC; color: #000000;">
                            ...
                            <th id="Th6" runat="server">N2</th>
                            <th id="Th7" runat="server">O2</th>
