Public Class StandardSampleOXReceiveEdit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Me.tbDeviceName.Text = "TC136"
            Me.tbFK_SampleNumber.Text = "C4800"
        End If
    End Sub
...
#Region "產生查詢字串至控制項 函式:MakQryStringToControl"
    ...
    Private Sub MakQryStringToControl()
        ...
        SQLString.Append("SELECT * FROM [標準樣本接收資料OX]" & vbNewLine)
        ...
        If Not String.IsNullOrEmpty(tbDeviceName.Text) Then SQLString.Append("    AND MachineID='" & tbDeviceName.Text & "'" & vbNewLine)
...
#Region "Search"
    ...
    Public Function Search(ByVal fromSQL As String, ByVal fromTopDataNum As String, ByVal fromSearchDate As String) As List(Of SQLServer.QCDB01.標準樣本接收資料OX)
        Dim queryList As New List(Of SQLServer.QCDB01.標準樣本接收資料OX)
        Dim retList As New List(Of SQLServer.QCDB01.標準樣本接收資料OX)
        ...
        queryList = SQLServer.QCDB01.標準樣本接收資料OX.CDBSelect(Of SQLServer.QCDB01.標準樣本接收資料OX)(SQLServerSQLQueryAdapter.ConnectionMoeEnum.ADO, fromSQL)
...
#Region "CDBUpdate"
    ...
    Public Function CDBUpdate(ByVal fromObject As SQLServer.QCDB01.標準樣本接收資料OX) As Integer
...
#Region "CDBDelete"
    ...
    Public Function CDBDelete(ByVal fromObject As SQLServer.QCDB01.標準樣本接收資料OX) As Integer
        fromObject.SQLQueryAdapterByThisObject = New SQLServerSQLQueryAdapter(SQLServerSQLQueryAdapter.ConnectionMoeEnum.ADO, SQLServerSQLQueryAdapter.ConnectServerNameEnum.Server04m, "QCDB01")
