...
#Region "依GridViewRow變更顏色 函式:ChangeGridViewCellColorForData"
    ...
    Public Sub ChangeGridViewCellColorForData(ByVal SourceGridView As GridView, ByVal GetGridViewRow As GridViewRow)
        ...
        For Each EachField As DataControlField In SourceGridView.Columns
            ...
            Select Case True
                Case FieldName = "DF"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.DF, LDatarow.DF)
                Case FieldName = "MD30"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.MD30, LDatarow.MD30)
                Case FieldName = "C"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.C, LDatarow.C)
                Case FieldName = "SI"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Si, LDatarow.Si)
                Case FieldName = "MN"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Mn, LDatarow.Mn)
                Case FieldName = "P"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.P, LDatarow.P)
                Case FieldName = "CR"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Cr, LDatarow.Cr)
                Case FieldName = "NI"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Ni, LDatarow.Ni)
                Case FieldName = "CU"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Cu, LDatarow.Cu)
                Case FieldName = "MO"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Mo, LDatarow.Mo)
                Case FieldName = "SN"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Sn, LDatarow.Sn)
                Case FieldName = "PB"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Pb, LDatarow.Pb)
                Case FieldName = "N2"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.N2, LDatarow.N2)
                    If GetDataRow.Item(FieldName) = "0.000" Then
                        GetGridViewRow.Cells(ColumnIndex).ForeColor = Drawing.Color.Red
                    End If
                Case FieldName = "CO"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Co, LDatarow.Co)
                Case FieldName = "AL"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.AL, LDatarow.AL)
                Case FieldName = "TI"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Ti, LDatarow.Ti)
                Case FieldName = "NB"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Nb, LDatarow.Nb)
                Case FieldName = "O2"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.O2, LDatarow.O2)
                    If GetDataRow.Item(FieldName) = "0.000" Then
                        GetGridViewRow.Cells(ColumnIndex).ForeColor = Drawing.Color.Red
                    End If
                Case FieldName = "B"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.B, LDatarow.B)
                Case FieldName = "CA"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Ca, LDatarow.Ca)
                Case FieldName = "MG"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.Mg, LDatarow.Mg)
                Case FieldName = "V"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), GetDataRow.Item(FieldName), HDatarow.V, LDatarow.V)




                Case FieldName = "S"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), ModTools.NoNull(GetDataRow.Item(FieldName), 0), HDatarow.S, LDatarow.S)
                Case FieldName = "FE"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), ModTools.NoNull(GetDataRow.Item(FieldName), 0), HDatarow.Fe, LDatarow.Fe)
                Case FieldName = "AS"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), ModTools.NoNull(GetDataRow.Item(FieldName), 0), HDatarow.As, LDatarow.As)
                Case FieldName = "BI"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), ModTools.NoNull(GetDataRow.Item(FieldName), 0), HDatarow.Bi, LDatarow.Bi)
                Case FieldName = "SB"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), ModTools.NoNull(GetDataRow.Item(FieldName), 0), HDatarow.Sb, LDatarow.Sb)
                Case FieldName = "ZN"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), ModTools.NoNull(GetDataRow.Item(FieldName), 0), HDatarow.Zn, LDatarow.Zn)
                Case FieldName = "ZR"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), ModTools.NoNull(GetDataRow.Item(FieldName), 0), HDatarow.Zr, LDatarow.Zr)
                Case FieldName = "GP"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), ModTools.NoNull(GetDataRow.Item(FieldName), 0), HDatarow.GP, LDatarow.GP)
                Case FieldName = "TA"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), ModTools.NoNull(GetDataRow.Item(FieldName), 0), HDatarow.Ta, LDatarow.Ta)
                Case FieldName = "CANDN"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), ModTools.NoNull(GetDataRow.Item(FieldName), 0), HDatarow.CAndN, LDatarow.CAndN)
                Case FieldName = "NBANDTA"
                    ChangeCellColor(GetGridViewRow.Cells(ColumnIndex), ModTools.NoNull(GetDataRow.Item(FieldName), 0), HDatarow.NbAndTa, LDatarow.NbAndTa)
