<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SQLServerStoveElementSearch.ascx.vb" Inherits="QualityControl.SQLServerStoveElementSearch" %>
...
<table style="width: 100%;">
    ...
    <tr>
        <td class="style1">判定篩選:</td>
        <td>
            <asp:TextBox ID="TBJudge" runat="server"></asp:TextBox>
            (兩個以上以 &#39;,&#39; 分隔 ex:Y1,Y2,N)</td>
    </tr>
    <tr>
        <td>驗收料篩選:</td>
        <td>
            <asp:RadioButtonList ID="rbCheckMaterial" runat="server"
                ...
                <asp:ListItem Value=" ">一般料</asp:ListItem>
                <asp:ListItem Value="Y">一般驗收料</asp:ListItem>
                <asp:ListItem Value="YA">合金驗收料</asp:ListItem>
            </asp:RadioButtonList>
        </td>
    </tr>
    <tr>
...
<asp:GridView ID="GridView1" runat="server" AllowSorting="True"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="判定代碼" HeaderText="判定代碼" SortExpression="判定代碼" />
...
<asp:ObjectDataSource ID="odsSearchResult" runat="server" SelectMethod="Search"
    TypeName="QualityControl.SQLServerStoveElementSearch">
    <SelectParameters>
