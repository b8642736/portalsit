<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="BlackCoilUnDoSearch.ascx.vb" Inherits="QualityControl.BlackCoilUnDoSearch" %>
<style type="text/css">
    .style1
    {
        width: 108px;
...
<asp:ObjectDataSource ID="odsSearchResult" runat="server" SelectMethod="Search" 
    TypeName="QualityControl.BlackCoilUnDoSearch">
    <SelectParameters>
