Public Partial Class CoilDefectSearch
...
#Region "查詢 方法:Search"
    ...
    Public Function Search(ByVal SQLString As String, ByVal DFAndMD30Range As String, ByVal OrderFieldList As String, ByVal FilterDefectNumber As Integer, ByVal FilterMaxBugTotalVLength As Double) As QualityControlDataSet.CoilDefectSearchDataTableDataTable
        If String.IsNullOrEmpty(SQLString) Then
            Return New QualityControlDataSet.CoilDefectSearchDataTableDataTable
        End If
        Dim ReturnValue As New QualityControlDataSet.CoilDefectSearchDataTableDataTable
        Dim ShowTitleInfoKey As QualityControlDataSet.CoilDefectSearchDataTableRow = Nothing
        ...
        For Each EachItem As DataRow In SearchTemp
            Dim ADDItem As QualityControlDataSet.CoilDefectSearchDataTableRow = ReturnValue.NewRow
            With ADDItem
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Function Search1(ByVal SQLString As String, ByVal DFAndMD30Range As String, ByVal OrderFieldList As String, ByVal FilterDefectNumber As Integer, ByVal FilterMaxBugTotalVLength As Double) As QualityControlDataSet.CoilDefectSearchDataTable1DataTable
        If String.IsNullOrEmpty(SQLString) Then
            Return New QualityControlDataSet.CoilDefectSearchDataTable1DataTable
        End If
        Dim ReturnValue As New QualityControlDataSet.CoilDefectSearchDataTable1DataTable
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Function Search2(ByVal SQLString As String, ByVal DFAndMD30Range As String, ByVal OrderFieldList As String, ByVal FilterDefectNumber As Integer, ByVal FilterMaxBugTotalVLength As Double) As QualityControlDataSet.CoilDefectSearchDataTable2DataTable
        If String.IsNullOrEmpty(SQLString) Then
            Return New QualityControlDataSet.CoilDefectSearchDataTable2DataTable
        End If
        Dim ReturnValue As New QualityControlDataSet.CoilDefectSearchDataTable2DataTable
        Dim ShowTitleInfoKey As DataRow = Nothing
        Dim NumberCount As Integer = 0
        Dim CoilBugAssey As List(Of CompanyORMDB.PPS100LB.PPSDEFPF) = CompanyORMDB.PPS100LB.PPSDEFPF.ALL_PPSDEPF(New CompanyORMDB.AS400SQLQueryAdapter(CompanyORMDB.AS400SQLQueryAdapter.ConnectionMoeEnum.ODBC))
        Dim SearchTemp As List(Of DataRow) = (From A In SearchBase(SQLString, DFAndMD30Range) Select A Order By A.Item(OrderFieldList.Split(",")(0)), A.Item(OrderFieldList.Split(",")(1)), A.Item(OrderFieldList.Split(",")(2)), A.Item(OrderFieldList.Split(",")(3)), A.Item(OrderFieldList.Split(",")(4)), A.Item(OrderFieldList.Split(",")(5)), A.Item(OrderFieldList.Split(",")(6))).ToList
        ...
        For Each EachItem As DataRow In SearchTemp
            Dim EachItemTemp As DataRow = EachItem
            Dim ADDItem As QualityControlDataSet.CoilDefectSearchDataTable2Row = ReturnValue.NewRow
            With ADDItem
                Dim IsTitleInfoKeyChanged As Boolean = Not IsNothing(ShowTitleInfoKey) AndAlso (ShowTitleInfoKey("熱軋號碼") <> EachItem.Item("BLA01") OrElse ShowTitleInfoKey("熱軋批次") <> EachItem.Item("BLA11") OrElse ShowTitleInfoKey("鋼胚號碼") <> EachItem.Item("BLA07") OrElse ShowTitleInfoKey("鋼捲號碼") <> EachItem.Item("BLA09") OrElse ShowTitleInfoKey("鋼種") <> EachItem.Item("QCA05") OrElse ShowTitleInfoKey("鋼胚產日") <> EachItem.Item("QCA02"))
                'If IsNothing(ShowTitleInfoKey) OrElse IsTitleInfoKeyChanged OrElse TraceLineDateValue <> EachItem.Item("QDE04") Then
                'End If
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Function Search3(ByVal SQLString As String, ByVal DFAndMD30Range As String, ByVal OrderFieldList As String, ByVal FilterDefectNumber As Integer, ByVal FilterMaxBugTotalVLength As Double) As QualityControlDataSet.CoilDefectSearchDataTable3DataTable
        '此格式非李東營使用可以變更
        If String.IsNullOrEmpty(SQLString) Then
            Return New QualityControlDataSet.CoilDefectSearchDataTable3DataTable
        End If
        Dim ReturnValue As New QualityControlDataSet.CoilDefectSearchDataTable3DataTable
        Dim ShowTitleInfoKey As DataRow = Nothing
        Dim NumberCount As Integer = 0
        Dim CoilBugAssey As List(Of CompanyORMDB.PPS100LB.PPSDEFPF) = CompanyORMDB.PPS100LB.PPSDEFPF.ALL_PPSDEPF(New CompanyORMDB.AS400SQLQueryAdapter(CompanyORMDB.AS400SQLQueryAdapter.ConnectionMoeEnum.ODBC))
        Dim SearchTemp As List(Of DataRow) = (From A In SearchBase(SQLString, DFAndMD30Range) Select A Order By A.Item(OrderFieldList.Split(",")(0)), A.Item(OrderFieldList.Split(",")(1)), A.Item(OrderFieldList.Split(",")(2)), A.Item(OrderFieldList.Split(",")(3)), A.Item(OrderFieldList.Split(",")(4)), A.Item(OrderFieldList.Split(",")(5)), A.Item(OrderFieldList.Split(",")(6))).ToList
        ...
        Dim AllCoilNumbers As New StringBuilder
        For Each EachItem As DataRow In SearchTemp
            Dim EachItemTemp As DataRow = EachItem
            Dim ADDItem As QualityControlDataSet.CoilDefectSearchDataTable3Row = ReturnValue.NewRow
            With ADDItem
                Dim IsTitleInfoKeyChanged As Boolean = Not IsNothing(ShowTitleInfoKey) AndAlso (ShowTitleInfoKey("熱軋號碼") <> EachItem.Item("BLA01") OrElse ShowTitleInfoKey("熱軋批次") <> EachItem.Item("BLA11") OrElse ShowTitleInfoKey("鋼胚號碼") <> EachItem.Item("BLA07") OrElse ShowTitleInfoKey("鋼捲號碼") <> EachItem.Item("BLA09") OrElse ShowTitleInfoKey("鋼種") <> EachItem.Item("QCA05") OrElse ShowTitleInfoKey("鋼胚產日") <> EachItem.Item("QCA02"))
                ...
                .鋼胚號碼 = EachItem.Item("BLA07")
                .鋼捲號碼 = EachItem.Item("BLA09")
                If String.IsNullOrEmpty(AllCoilNumbers.ToString) Then
                    AllCoilNumbers.Append(.鋼捲號碼)
                Else
                    AllCoilNumbers.Append("," & .鋼捲號碼)
                End If
                .鋼種 = EachItem.Item("QCA05")
        ...
        PutZMLRunProcessDataToSoureData(AllCoilNumbers.ToString, ReturnValue)
        Return ReturnValue

    End Function

    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Function Search4(ByVal SQLString As String, ByVal DFAndMD30Range As String, ByVal OrderFieldList As String, ByVal FilterDefectNumber As Integer, ByVal FilterMaxBugTotalVLength As Double) As QualityControlDataSet.CoilDefectSearchDataTable4DataTable
        '此格式非李東營使用可以變更
        If String.IsNullOrEmpty(SQLString) Then
            Return New QualityControlDataSet.CoilDefectSearchDataTable4DataTable
        End If
        Dim ReturnValue As New QualityControlDataSet.CoilDefectSearchDataTable4DataTable
        Dim ShowTitleInfoKey As DataRow = Nothing
        Dim NumberCount As Integer = 0
        Dim CoilBugAssey As List(Of CompanyORMDB.PPS100LB.PPSDEFPF) = CompanyORMDB.PPS100LB.PPSDEFPF.ALL_PPSDEPF(New CompanyORMDB.AS400SQLQueryAdapter(CompanyORMDB.AS400SQLQueryAdapter.ConnectionMoeEnum.ODBC))
        Dim SearchTemp As List(Of DataRow) = (From A In SearchBase(SQLString, DFAndMD30Range) Select A Order By A.Item(OrderFieldList.Split(",")(0)), A.Item(OrderFieldList.Split(",")(1)), A.Item(OrderFieldList.Split(",")(2)), A.Item(OrderFieldList.Split(",")(3)), A.Item(OrderFieldList.Split(",")(4)), A.Item(OrderFieldList.Split(",")(5)), A.Item(OrderFieldList.Split(",")(6))).ToList
        ...
        For Each EachItem As DataRow In SearchTemp
            Dim EachItemTemp As DataRow = EachItem
            Dim ADDItem As QualityControlDataSet.CoilDefectSearchDataTable4Row = ReturnValue.NewRow
            With ADDItem
                Dim IsTitleInfoKeyChanged As Boolean = Not IsNothing(ShowTitleInfoKey) AndAlso (ShowTitleInfoKey("熱軋號碼") <> EachItem.Item("BLA01") OrElse ShowTitleInfoKey("熱軋批次") <> EachItem.Item("BLA11") OrElse ShowTitleInfoKey("鋼胚號碼") <> EachItem.Item("BLA07") OrElse ShowTitleInfoKey("鋼捲號碼") <> EachItem.Item("BLA09") OrElse ShowTitleInfoKey("鋼種") <> EachItem.Item("QCA05") OrElse ShowTitleInfoKey("鋼胚產日") <> EachItem.Item("QCA02"))
                ...
                .缺陷代號 = EachItemTemp.Item("QDE05")
                Dim GetCoilBugAssey As CompanyORMDB.PPS100LB.PPSDEFPF = (From A In CoilBugAssey Where A.DEF01 = CType(EachItemTemp.Item("QDE05"), String) Select A).FirstOrDefault
                If Not IsNothing(GetCoilBugAssey) Then
                    .缺陷名稱 = GetCoilBugAssey.DEF02
                End If
...
#Region "將ZML RunprocessData資料放入RunProcessDataToSoureData 函式:PutZMLRunProcessDataToSoureData"
    ''' <summary>
    ''' 將ZML RunprocessData資料放入RunProcessDataToSoureData
    ''' </summary>
    ''' <param name="CoilNumbers"></param>
    ''' <param name="SourceData"></param>
    ''' <remarks></remarks>
    Private Sub PutZMLRunProcessDataToSoureData(ByVal CoilNumbers As String, ByVal SourceData As QualityControlDataSet.CoilDefectSearchDataTable3DataTable)
        Dim QryString As String = "Select FK_LastRefSHA01,FK_LastRefSHA02,FK_LastRefSHA04,ZML_SURod1,ZML_SURod2,ZML_SURod3,ZML_SDRod1,ZML_SDRod2,ZML_SDRod3,ZML_Bised,ZML_Scare,ZML_Bised,ZML_Peels,ZML_SideState,ZML_OilColor,ZML_OilIsReUse,ZML_OiIslPressNormal From RunProcessData Where (FK_RunStationName IN ('ZML1', 'ZML2', 'ZML3')) AND (NOT (ZML_BURod1 IS NULL)) AND (ZML_BURod1 <> '')"
        QryString &= " AND RTRIM(FK_LastRefSHA01 + FK_LastRefSHA02) IN ('" & CoilNumbers.Replace(",", "','") & "')"
        QryString &= " UNION " & QryString.Replace("From RunProcessData", "From RunProcessDataHistory")
        ...
        For Each EachItem As QualityControlDataSet.CoilDefectSearchDataTable3Row In SourceData.Rows
            Dim FindData As DataRow = (From A In SearchResult Where Trim(A.Item("FK_LastRefSHA01") & A.Item("FK_LastRefSHA02")) = EachItem.鋼捲號碼.Trim Select A).FirstOrDefault
            If Not IsNothing(FindData) Then
                With EachItem
                    If Not IsDBNull(FindData.Item("ZML_SURod1")) Then
                        .上左工輥 = FindData.Item("ZML_SURod1")
                    End If
                    If Not IsDBNull(FindData.Item("ZML_SURod2")) Then
                        .上工輥 = FindData.Item("ZML_SURod2")
                    End If
                    If Not IsDBNull(FindData.Item("ZML_SURod3")) Then
                        .上右工輥 = FindData.Item("ZML_SURod3")
                    End If
                    If Not IsDBNull(FindData.Item("ZML_SDRod1")) Then
                        .下左工輥 = FindData.Item("ZML_SDRod1")
                    End If
                    If Not IsDBNull(FindData.Item("ZML_SDRod2")) Then
                        .下工輥 = FindData.Item("ZML_SDRod2")
                    End If
                    If Not IsDBNull(FindData.Item("ZML_SDRod3")) Then
                        .下右工輥 = FindData.Item("ZML_SDRod3")
                    End If
                    If Not IsDBNull(FindData.Item("ZML_Scare")) Then
                        .頭尾鑿痕 = FindData.Item("ZML_Scare")
                    End If
                    If Not IsDBNull(FindData.Item("ZML_Bised")) Then
                        .片偏 = FindData.Item("ZML_Bised")
                    End If
                    If Not IsDBNull(FindData.Item("ZML_Peels")) Then
                        .剝片程度 = FindData.Item("ZML_Peels")
                    End If
                    If Not IsDBNull(FindData.Item("ZML_SideState")) Then
                        .邊緣狀況 = FindData.Item("ZML_SideState")
                    End If
                    If Not IsDBNull(FindData.Item("ZML_OilColor")) Then
                        .油色澤 = FindData.Item("ZML_OilColor")
                    End If
                    If Not IsDBNull(FindData.Item("ZML_OilIsReUse")) Then
                        .是否再生 = FindData.Item("ZML_OilIsReUse")
                    End If
                    If Not IsDBNull(FindData.Item("ZML_OiIslPressNormal")) Then
                        .油壓 = FindData.Item("ZML_OiIslPressNormal")
                    End If
                End With
            End If
        Next
    ...
    Private Sub PutZMLRunProcessDataToSoureData(ByVal CoilNumbers As String, ByVal SourceData As QualityControlDataSet.CoilDefectSearchDataTable4DataTable)
        Dim QryString As String = "Select FK_LastRefSHA01,FK_LastRefSHA02,FK_LastRefSHA04,ZML_SURod1,ZML_SURod2,ZML_SURod3,ZML_SDRod1,ZML_SDRod2,ZML_SDRod3,ZML_Bised,ZML_Scare,ZML_Bised,ZML_Peels,ZML_SideState,ZML_OilColor,ZML_OilIsReUse,ZML_OiIslPressNormal From RunProcessData Where (FK_RunStationName IN ('ZML1', 'ZML2', 'ZML3')) AND (NOT (ZML_BURod1 IS NULL)) AND (ZML_BURod1 <> '')"
        QryString &= " AND RTRIM(FK_LastRefSHA01 + FK_LastRefSHA02) IN ('" & CoilNumbers.Replace(",", "','") & "')"
        QryString &= " UNION " & QryString.Replace("From RunProcessData", "From RunProcessDataHistory")
        Dim Adapter As New CompanyORMDB.SQLServerSQLQueryAdapter(SQLServerSQLQueryAdapter.ConnectionMoeEnum.ADO, SQLServerSQLQueryAdapter.ConnectServerNameEnum.Server04m, "PPS100LB")
        Dim SearchResult As DataTable = Adapter.SelectQuery(QryString)
        For Each EachItem As QualityControlDataSet.CoilDefectSearchDataTable4Row In SourceData.Rows
            Dim FindData As DataRow = (From A In SearchResult Where Trim(A.Item("FK_LastRefSHA01") & A.Item("FK_LastRefSHA02")) = EachItem.鋼捲號碼.Trim Select A).FirstOrDefault
            If Not IsNothing(FindData) Then
                With EachItem
                    If Not IsDBNull(FindData.Item("ZML_SURod1")) Then
...
#Region "控制項Where條件產生器 方法:ControlWhereMaker"
    ...
    Private ReadOnly Property ControlWhereMaker() As String
        Get
            ...
            Select Case True
                Case ddlOutFormat.SelectedValue = "Format3" OrElse ddlOutFormat.SelectedValue = "Format4" '格式3/格式4,輸出格式Join 排程資料
                    ReturnValue.Append("Select A.*,B.BLA01,B.BLA03,B.BLA11,B.BLA07,B.BLA09,C.QDE01,C.QDE04,C.QDE05,C.QDE13,C.QDE09,C.QDE13,C.QDE07,C.QDE08,C.QDE10,C.QDE11,C.QDE12,C.QDE14 " & _
                        ...
                        ",E.SHA08,E.SHA09,E.SHA14,E.SHA22,E.SHA23,E.SHA21,E.SHA24,E.SHA25" & _
                ...
                Case ddlOutFormat.SelectedValue = "Format2" '格式2,輸出格式Join 排程資料
                    ...
                    '    " From  @#PPS100LB.PPSQCAPF A,@#PPS100LB.PPSBLAPF B,@#PPS100LB.PPSQDEPF C,@#PPS100LB.PPSSHAPF E  LEFT JOIN @#SMS100LB.SMSREGPF F ON A.QCA01=Left(F.T2,5) AND A.QCA02<=F.T1 AND A.QCA02>=(F.T1-10000) " & _
                    '    " WHERE (A.QCA01 = Left(B.BLA07, 5) And B.BLA09 = C.QDE02)" & _
                    '    " AND A.QCA02<=B.BLA08 AND B.BLA08<=C.QDE04 AND B.BLA15='  ' " & _
                    '    " AND C.QDE02=E.SHA01 AND C.QDE03=E.SHA02")
                Case Not CheckBox3.Checked  '預設格式
                    ...
                    '    " From  @#PPS100LB.PPSQCAPF A,@#PPS100LB.PPSBLAPF B,@#PPS100LB.PPSQDEPF C LEFT JOIN @#SMS100LB.SMSREGPF F ON A.QCA01=Left(F.T2,5) AND A.QCA02<=F.T1 AND A.QCA02>=(F.T1-10000) " & _
                    '    " WHERE (A.QCA01 = Left(B.BLA07, 5) And B.BLA09 = C.QDE02)" & _
                    '    " AND A.QCA02<=B.BLA08 AND B.BLA08<=C.QDE04 AND B.BLA15='  ' ")
                Case CheckBox3.Checked  '格式1
                    ...
                    '    " From  @#PPS100LB.PPSQCAPF A,@#PPS100LB.PPSBLAPF B,@#PPS100LB.PPSQDEPF C  LEFT JOIN @#PPS100LB.PPSQDSPF D ON C.QDE01=D.QDS01 AND C.QDE02=D.QDS02 AND C.QDE03=D.QDS03 AND C.QDE04=D.QDS04  LEFT JOIN @#SMS100LB.SMSREGPF F ON A.QCA01=Left(F.T2,5) AND A.QCA02<=F.T1 AND A.QCA02>=(F.T1-10000) " & _
                    '    " WHERE (A.QCA01 = Left(B.BLA07, 5) And B.BLA09 = C.QDE02)" & _
                    '    " AND A.QCA02<=B.BLA08 AND B.BLA08<=C.QDE04 AND B.BLA15='  ' ")
            End Select
            ...
            If Not String.IsNullOrEmpty(tbLotsNumbers.Text) Then
                ...
                End If
            End If
            'If Not String.IsNullOrEmpty(tbDensity.Text) Then
            '    tbDensity.Text = tbDensity.Text.Replace("'", Nothing)
            '    WhereValue &= IIf(tbDensity.Text.Trim.Length > 0, " AND C.QDE14 IN ('" & tbDensity.Text.Replace(",", "','") & "')", Nothing)
            'End If
            ...
            If (ddlOutFormat.SelectedValue = "Format2" Or ddlOutFormat.SelectedValue = "Format3") AndAlso Not String.IsNullOrEmpty(tbSchedualLines.Text) AndAlso tbSchedualLines.Text.Trim.Length > 0 Then
...
#End Region
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Select Case True
            ...
            Case ddlOutFormat.SelectedValue = "Format3"
                Me.GridView3.DataBind()
                Me.MultiView1.SetActiveView(Me.View4)
            Case ddlOutFormat.SelectedValue = "Format4"
    ...
    Private Sub btnSearchDownExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchDownExcel.Click
        ...
        Select Case True
            ...
            Case ddlOutFormat.SelectedValue = "Format3"
                ExcelConvert = New PublicClassLibrary.DataConvertExcel(Search3(Me.hfSQLString.Value, Me.hfDFAndMD30Range.Value, Me.hfSortFieldsList.Value, Me.hfMinDefectFilterNumber.Value, hfMaxBugTotalVLength.Value), "鋼捲缺陷查詢_產線追踪格式2" & Format(Now, "mmss") & ".xls")
            Case ddlOutFormat.SelectedValue = "Format4"
                ExcelConvert = New PublicClassLibrary.DataConvertExcel(Search4(Me.hfSQLString.Value, Me.hfDFAndMD30Range.Value, Me.hfSortFieldsList.Value, Me.hfMinDefectFilterNumber.Value, hfMaxBugTotalVLength.Value), "鋼捲缺陷查詢_產線追踪格式3" & Format(Now, "mmss") & ".xls")
        End Select
