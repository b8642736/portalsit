<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CoilDefectPurchaseSearch.ascx.vb" Inherits="QualityControl.CoilDefectPurchaseSearch" %>
...
<asp:MultiView ID="MultiView1" runat="server"
    ...
    <asp:View ID="SearchView" runat="server">
        ...
        <table style="width: 100%;">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="tbBugWidthS" runat="server" Width="70px">0</asp:TextBox>
                                ~<asp:TextBox ID="tbBugWidthE" runat="server" Width="70px">9999</asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td>頭尾<asp:TextBox ID="tbQDS30DelLeng" runat="server" Height="20px" Width="39px">15</asp:TextBox>
                    呎缺陷移除</td>
            </tr>

            <tr>
                <td class="style1">公稱寬度:</td>
                <td>
            ...
            <tr>
                <td class="style1">是否購買白皮鋼捲</td>
                <td>
                    <asp:CheckBox ID="cbIsBuyWiteCoil" runat="server" Text="是" /></td>
            </tr>
            <tr>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:ListBox ID="lbSort" runat="server" AutoPostBack="True" Width="146px"
                                ...
                                <asp:ListItem Value="QCI02">鋼胚產日</asp:ListItem>
                                <asp:ListItem Value="QCI05">鋼種</asp:ListItem>
                                <asp:ListItem Value="QCI06">材質</asp:ListItem>
                            </asp:ListBox>
    ...
    <asp:View ID="View1" runat="server">
        ...
        <asp:ObjectDataSource ID="odsSearchResult" runat="server" SelectMethod="Search"
            TypeName="QualityControl.CoilDefectPurchaseSearch">
            <SelectParameters>
    ...
    <asp:View ID="View2" runat="server">
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="追縱線別日期" HeaderText="追縱線別日期" SortExpression="追縱線別日期" />
        ...
        <asp:ObjectDataSource ID="odsSearchResult1" runat="server"
            SelectMethod="Search1" TypeName="QualityControl.CoilDefectPurchaseSearch">
            <SelectParameters>
                <asp:ControlParameter ControlID="hfSQLString" Name="SQLString"
                    PropertyName="Value" Type="String" />
                <asp:ControlParameter ControlID="hfDFAndMD30Range" Name="DFAndMD30Range"
    ...
    <asp:View ID="View3" runat="server">
        ...
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False"
            DataSourceID="odsSearchResult2" EnableViewState="False" Width="2200px">
            <Columns>
                <asp:BoundField DataField="序號" HeaderText="序號" SortExpression="序號" />
                <asp:BoundField DataField="鋼捲號碼" HeaderText="鋼捲號碼" SortExpression="鋼捲號碼" />
                <asp:BoundField DataField="鋼種" HeaderText="鋼種" SortExpression="鋼種" />
        ...
        <asp:ObjectDataSource ID="odsSearchResult2" runat="server"
            SelectMethod="Search2" TypeName="QualityControl.CoilDefectPurchaseSearch">
            <SelectParameters>
                <asp:ControlParameter ControlID="hfSQLString" Name="SQLString"
                    PropertyName="Value" Type="String" />
                <asp:ControlParameter ControlID="hfDFAndMD30Range" Name="DFAndMD30Range"
