<%--<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="LabRecordA2_Setting_Remark_RES_ASSAY.ascx.vb" Inherits="QualityControl.LabRecordA2_Setting_Remark_RES_ASSAY" %>--%>
<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="LabRecordA2_Setting_Remark_RES_ASSAY.ascx.vb" Inherits="QualityControl.LabRecordA2_Setting_Remark_RES_ASSAY"  %>
...
<table id="HtmlTab1" class="myTab1">
    <tr>
                ...
                <ContentTemplate>
                    ...
                    <table id="HtmlTab1_A" class="myTab1" style="width: 100%">
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="queryKey5CheckBox" runat="server" Visible="False" OnCheckedChanged="queryKeyCheckBox_CheckedChanged" AutoPostBack="True" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="queryKey3CheckBox" runat="server" OnCheckedChanged="queryKeyCheckBox_CheckedChanged" AutoPostBack="True" />
                            ...
                            <td>
                                <asp:CheckBox ID="queryKey4CheckBox" runat="server" OnCheckedChanged="queryKeyCheckBox_CheckedChanged" AutoPostBack="True" />
                        ...
                        <tr>
                            ...
                            <td style="width: 30%">
                                <asp:CheckBox ID="queryKey1CheckBox" runat="server" OnCheckedChanged="queryKeyCheckBox_CheckedChanged" AutoPostBack="True" />
                                <asp:DropDownList ID="queryKey1DropDownList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="queryKeyDropDownList_SelectedIndexChanged" />
                            </td>
                            <td style="width: 10%">
                                <asp:Label ID="Label5" runat="server" Text="表面類別：" />
                            </td>
                            <td style="width: 30%; font-weight: 700;">
                                <asp:CheckBox ID="queryKey2CheckBox" runat="server" OnCheckedChanged="queryKeyCheckBox_CheckedChanged" AutoPostBack="True" />
                                <asp:DropDownList ID="queryKey2DropDownList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="queryKeyDropDownList_SelectedIndexChanged" />
                            </td>
                        </tr>
        ...
        <td>
            ...
            <asp:ObjectDataSource ID="ods" runat="server" InsertMethod="Insert" SelectMethod="Search" TypeName="QualityControl.LabRecordA2_Setting_Remark_RES_ASSAY" UpdateMethod="Update" DataObjectTypeName="CompanyORMDB.SQLServer.QCDB01.LabRecordA2_Remark_RESAssay" DeleteMethod="Delete">
                <SelectParameters>
...
<asp:ListView ID="ListView1" runat="server" DataKeyNames="參照規範,表面類別,鋼種,材質,REMARK_ID,ASSAY_ID" DataSourceID="ods" InsertItemPosition="LastItem">
    <AlternatingItemTemplate>
        <tr style="background-color: #FFF8DC;">
            ...
            <td>                
                ...
                <br />
                <asp:Label ID="JUDGET_TYPELabel" runat="server" Text='<%# showJUDGET_TYPE(Eval("JUDGET_TYPE"))%>' />
                <br />
                <asp:Label ID="JUDGET_DOCLabel" runat="server" Text='<%# Eval("JUDGET_DOC") %>' />
            </td>
    ...
    <EditItemTemplate>
        <tr style="background-color: #008A8C; color: #FFFFFF;">
            ...
            <td>                
                ...
                <br />
                <asp:TextBox ID="JUDGET_TYPETextBox" runat="server" Text='<%# Bind("JUDGET_TYPE") %>' Visible="false" />
                <asp:DropDownList ID="EditJUDGET_TYPEDropDownList" runat="server" />
                <br />
                <asp:TextBox ID="EditJUDGET_DOCTextBox" runat="server" Text='<%# Bind("JUDGET_DOC") %>' />
            </td>
    ...
    <InsertItemTemplate>
        <tr style="">
            ...
            <td class="td_key">
                ...
                <asp:DropDownList ID="EditKey5DropDownList" runat="server" OnSelectedIndexChanged="editKeyDropDownList_SelectedIndexChanged" AutoPostBack="True" />                
            </td>

           <td class="td_key">
                <asp:TextBox ID="鋼種TextBox" runat="server" Text='<%# Bind("鋼種") %>' Visible="false" />
                <asp:DropDownList ID="EditKey3DropDownList" runat="server" OnSelectedIndexChanged="editKeyDropDownList_SelectedIndexChanged" AutoPostBack="True" />
            </td>
            <td class="td_key">
                <asp:TextBox ID="材質TextBox" runat="server" Text='<%# Bind("材質") %>' Visible="false" />
                <asp:DropDownList ID="EditKey4DropDownList" runat="server" OnSelectedIndexChanged="editKeyDropDownList_SelectedIndexChanged" AutoPostBack="True" />
            </td>


            <td class="td_key">
                <asp:TextBox ID="參照規範TextBox" runat="server" Text='<%# Bind("參照規範") %>' Visible="false" />
                <asp:DropDownList ID="EditKey1DropDownList" runat="server" OnSelectedIndexChanged="editKeyDropDownList_SelectedIndexChanged" AutoPostBack="True" />
            </td>
            <td class="td_key">
                <asp:TextBox ID="表面類別TextBox" runat="server" Text='<%# Bind("表面類別") %>' Visible="false" />
                <asp:DropDownList ID="EditKey2DropDownList" runat="server" OnSelectedIndexChanged="editKeyDropDownList_SelectedIndexChanged" AutoPostBack="True" />
            </td>
 

            <td>
                <asp:TextBox ID="ASSAY_IDTextBox" runat="server" Text='<%# Bind("ASSAY_ID") %>' Visible="false" />
                <asp:DropDownList ID="EditKey6DropDownList" runat="server" />
                <br />
                <asp:TextBox ID="JUDGET_TYPETextBox" runat="server" Text='<%# Bind("JUDGET_TYPE") %>' Visible="false" />
                <asp:DropDownList ID="EditJUDGET_TYPEDropDownList" runat="server" />
                <br />
