<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="LabRecordA2_Setting_Assay_RES_V2.ascx.vb" Inherits="QualityControl.LabRecordA2_Setting_Assay_RES_V2" %>
...
<table id="HtmlTab1" class="myTab1">
    <tr>
        ...
        <td>
            ...
            <asp:ObjectDataSource ID="ods" runat="server" InsertMethod="Insert" SelectMethod="Search" TypeName="QualityControl.LabRecordA2_Setting_Assay_RES_V2" UpdateMethod="Update" DataObjectTypeName="CompanyORMDB.SQLServer.QCDB01.LabRecordA2_Assay_RES" DeleteMethod="Delete">
                <SelectParameters>
...
<asp:ListView ID="ListView1" runat="server" DataKeyNames="參照規範,表面類別,鋼種,材質,ASSAY_ID" DataSourceID="ods" InsertItemPosition="LastItem">
    ...
    <EditItemTemplate>
        <tr style="background-color: #008A8C; color: #FFFFFF;">
            ...
            <td>
                <asp:TextBox ID="SAVE_OPERTextBox" runat="server" BackColor="#CCCCCC" CssClass="ListView1CSS_Lock" ReadOnly ="true"  Text='<%# Eval("SAVE_OPER") %>' />
                <br />
                <asp:TextBox ID="SAVE_DATETextBox" runat="server" BackColor="#CCCCCC" CssClass="ListView1CSS_Lock" ReadOnly ="true"  Text='<%# FS_DATE_FORMAT(Eval("SAVE_DATE"), 1) %>' />
            </td>
    ...
    <InsertItemTemplate>
        <tr style="">
            ...
            <td>
                <asp:TextBox ID="SAVE_OPERTextBox" runat="server" BackColor="#CCCCCC" CssClass="ListView1CSS_Lock" ReadOnly ="true"  />
                <br />
                <asp:TextBox ID="SAVE_DATETextBox" runat="server" BackColor="#CCCCCC" CssClass="ListView1CSS_Lock" ReadOnly="true" />
            </td>
