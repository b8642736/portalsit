...
Public Class LabRecordA2_Setting_Assay_RES_V1
...
#Region "GetDataKey"
    ...
    Private WP_editNORMAL_RANGE_L As String
    Private WP_editNORMAL_RANGE_H As String
    Private WP_editRESULT_FORMAT As String
    ...
    Private Sub P_Init_WP_Edit()
        ...
        WP_editNORMAL_RANGE_L = ""
        WP_editNORMAL_RANGE_H = ""
        WP_editRESULT_FORMAT = ""
        WP_editEFF_FLAG = ""
    ...
    Protected Sub P_KeeyValue_Item()
        ...
        WP_editNORMAL_RANGE_L = CType((W_Obj_ListViewItem.FindControl("EditNORMAL_RANGE_LTextBox")), TextBox).Text
        WP_editNORMAL_RANGE_H = CType((W_Obj_ListViewItem.FindControl("EditNORMAL_RANGE_HTextBox")), TextBox).Text

        WP_editRESULT_FORMAT = CType((W_Obj_ListViewItem.FindControl("EditRESULT_FORMATTextBox")), TextBox).Text
...
#Region "產生查詢字串至控制項  函式:MakeQryStringToControl"
    Private Sub MakeQryStringToControl()
        ...
        If queryKey5CheckBox.Checked = True Then
            Dim W_AssayID As String = WP_ClsSystemNote.Fs_GetStrBefor(queryKey5DropDownList.SelectedValue, WP_ClsSystemNote.Display_Symbol)
...
#Region "CRUD"
    ...
    Public Function Search(ByVal fromSQL As String) As List(Of LabRecordA2_Assay_RES)
        ...
        Dim dtResult As List(Of LabRecordA2_Assay_RES) = _
                    LabRecordA2_Assay_RES.CDBSelect(Of LabRecordA2_Assay_RES)(fromSQL.Split("|")(1), WP_SQLAdapter_Server04M_QCdb01)
...
#Region "ListView1"
    ...
    Public Sub CustomValidator_1_Insert_ServerValidate(source As Object, args As System.Web.UI.WebControls.ServerValidateEventArgs) 'Handles CustomValidator1.ServerValidate
        ...
        If Not listViewItemObj Is Nothing Then
            ...
            If W_DoModeIs = EditMode_Enum.新增 Then
                ...
                Dim W_AssayID As String = WP_ClsSystemNote.Fs_GetStrBefor(dropDownListObj.SelectedValue, WP_ClsSystemNote.Display_Symbol)
                ...
                Dim queryList As List(Of CompanyORMDB.SQLServer.QCDB01.LabRecordA2_Assay_RES) = _
                    CompanyORMDB.SQLServer.QCDB01.LabRecordA2_Assay_RES.CDBSelect(Of CompanyORMDB.SQLServer.QCDB01.LabRecordA2_Assay_RES)(W_SQL.ToString, WP_SQLAdapter_Server04M_QCdb01)
    ...
    Private Sub ListView1_ItemInserting(sender As Object, e As ListViewInsertEventArgs) Handles ListView1.ItemInserting
        ...
        e.Values("ASSAY_ID") = WP_ClsSystemNote.Fs_GetStrBefor(CType(W_Obj_listView.FindControl("EditKey5DropDownList"), DropDownList).SelectedValue, WP_ClsSystemNote.Display_Symbol)
    ...
    Private Sub ListView1_PreRender(sender As Object, e As EventArgs) Handles ListView1.PreRender
        ...
        textboxObj = CType(listViewItemObj.FindControl("EditNORMAL_RANGE_LTextBox"), TextBox)
        If WP_editNORMAL_RANGE_L <> "" Then
            textboxObj.Text = WP_editNORMAL_RANGE_L
        End If

        textboxObj = CType(listViewItemObj.FindControl("EditNORMAL_RANGE_HTextBox"), TextBox)
        If WP_editNORMAL_RANGE_H <> "" Then
            textboxObj.Text = WP_editNORMAL_RANGE_H
        End If

        textboxObj = CType(listViewItemObj.FindControl("EditRESULT_FORMATTextBox"), TextBox)
        If WP_editRESULT_FORMAT <> "" Then
            textboxObj.Text = WP_editRESULT_FORMAT
        End If
    ...
    Public Sub ListView1_BtnReadDefault_Click(sender As Object, e As EventArgs)
        ...
        WP_editKey5 = W_editKey5Text
        Dim W_AssayID As String = WP_ClsSystemNote.Fs_GetStrBefor(W_editKey5Text, WP_ClsSystemNote.Display_Symbol)
        LabRecordA2_Setting_Module.P_SetDropDownList_DataKey5_檢驗資訊(W_AssayID, W_NORMAL_RANGE_L, W_NORMAL_RANGE_H, W_RESULT_FORMAT)

        WP_editNORMAL_RANGE_L = W_NORMAL_RANGE_L.Text
        WP_editNORMAL_RANGE_H = W_NORMAL_RANGE_H.Text

        WP_editRESULT_FORMAT = W_RESULT_FORMAT.Text
...
#Region "P_INIT"
    ...
    Protected Function showAssayInfo(ByVal fromAssayID As String) As String
