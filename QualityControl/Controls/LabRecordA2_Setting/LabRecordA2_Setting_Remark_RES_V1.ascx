<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="LabRecordA2_Setting_Remark_RES_V1.ascx.vb" Inherits="QualityControl.LabRecordA2_Setting_Remark_RES_V1" %>
        ...
        <table class="myTab1">
            <tr>
                ...
                <td style="width: 10%; font-weight: 700;" rowspan="5">
                    ...
                    <asp:ObjectDataSource ID="ods" runat="server" InsertMethod="Insert" SelectMethod="Search" TypeName="QualityControl.LabRecordA2_Setting_Remark_RES_V1" UpdateMethod="Update" DataObjectTypeName="CompanyORMDB.SQLServer.QCdb01.LabRecordA2_Remark_RES" DeleteMethod="Delete">
                        <SelectParameters>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="參照規範,表面類別,鋼種,材質,REMARK_ID" DataSourceID="ods" EnableModelValidation="True" InsertItemPosition="LastItem">
            ...
            <EditItemTemplate>
                <tr style="background-color: #008A8C; color: #FFFFFF;">
                    ...
                    <td class="td_key">
                        ...
                        <asp:Label ID="EditREMARK_IDLabel" runat="server" Text='<%# showRemarkInfo(Eval("REMARK_ID"))%>' />
                        ...
                        <td runat="server">
                            <table id="itemPlaceholderContainer" runat="server" border="1" style="background-color: #FFFFFF; border-collapse: collapse; border-color: #999999; border-style: none; border-width: 1px; font-family: Verdana, Arial, Helvetica, sans-serif;">
                                <tr runat="server" style="background-color: #DCDCDC; color: #000000;">
                                    ...
                                    <th runat="server" class="td_key">片語項目</th>
