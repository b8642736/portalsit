<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CoilDefectSearch.ascx.vb" Inherits="QualityControl.CoilDefectSearch" %>
...
<%--            <tr>
                ...
                <td>
                    <asp:TextBox ID="tbDensity" runat="server"></asp:TextBox>(兩個以上以&nbsp; &#39;,&#39; 分隔)</td>
            </tr>--%>
            <tr>
                <td class="style1">
                    缺陷寬度:
            ...
            <tr>
                <td colspan="2">
                    ...
                    <asp:Button ID="btnSearchDownExcel" runat="server" Text="查詢下載Excel" 
                        Width="100px" />
                    <asp:DropDownList ID="ddlOutFormat" runat="server" Width="200px">
                        ...
                        <asp:ListItem Value="Format3">產線追踪格式2</asp:ListItem>
                        <asp:ListItem Value="Format4">產線追踪格式3</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
    ...
    <asp:View ID="View1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            EnableModelValidation="True" Width="2500px">
            <Columns>
        ...
        <asp:ObjectDataSource ID="odsSearchResult" runat="server" SelectMethod="Search" 
            TypeName="QualityControl.CoilDefectSearch">
            <SelectParameters>
    ...
    <asp:View ID="View2" runat="server">
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            DataSourceID="odsSearchResult1" EnableViewState="False" Width="3200px" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="缺陷名稱" HeaderText="缺陷名稱" SortExpression="缺陷名稱" />
        ...
        <asp:ObjectDataSource ID="odsSearchResult1" runat="server" 
            SelectMethod="Search1" TypeName="QualityControl.CoilDefectSearch">
            <SelectParameters>
                <asp:ControlParameter ControlID="hfSQLString" Name="SQLString" 
                    PropertyName="Value" Type="String" />
                <asp:ControlParameter ControlID="hfDFAndMD30Range" Name="DFAndMD30Range" 
    ...
    <asp:View ID="View3" runat="server">
        ...
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
            ...
            EnableViewState="False" Width="3200px">
            <Columns>
                <asp:BoundField DataField="序號" HeaderText="序號" SortExpression="序號" />
                <asp:BoundField DataField="鋼捲號碼" HeaderText="鋼捲號碼" SortExpression="鋼捲號碼" />
                <asp:BoundField DataField="鋼種" HeaderText="鋼種" SortExpression="鋼種" />
        ...
        <asp:ObjectDataSource ID="odsSearchResult2" runat="server" 
            SelectMethod="Search2" TypeName="QualityControl.CoilDefectSearch">
            <SelectParameters>
                <asp:ControlParameter ControlID="hfSQLString" Name="SQLString" 
                    PropertyName="Value" Type="String" />
                <asp:ControlParameter ControlID="hfDFAndMD30Range" Name="DFAndMD30Range" 
        ...
        <asp:Button ID="btnBackSearch4" runat="server" Text="返回查詢頁面" Width="108px" />
        <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" 
            DataSourceID="odsSearchResult3" EnableModelValidation="True" 
            EnableViewState="False" Width="4200px">
            <Columns>
                <asp:BoundField DataField="序號" HeaderText="序號" SortExpression="序號" />
                <asp:BoundField DataField="鋼捲號碼" HeaderText="鋼捲號碼" SortExpression="鋼捲號碼" />
                <asp:BoundField DataField="鋼種" HeaderText="鋼種" SortExpression="鋼種" />
                ...
                <asp:BoundField DataField="厚度" HeaderText="厚度" SortExpression="厚度" />
                <asp:BoundField DataField="產線厚度" HeaderText="產線厚度" SortExpression="產線厚度" />
                <asp:BoundField DataField="缺陷代號" HeaderText="缺陷代號" SortExpression="缺陷代號" />
                <asp:BoundField DataField="程度" HeaderText="程度" SortExpression="程度" />
                <asp:BoundField DataField="分佈" HeaderText="分佈" SortExpression="分佈" />
                <asp:BoundField DataField="直起" HeaderText="直起" SortExpression="直起" />
                ...
                <asp:BoundField DataField="Mg" HeaderText="Mg" SortExpression="Mg" />
                <asp:BoundField DataField="Fe" HeaderText="Fe" SortExpression="Fe" />
                <asp:BoundField DataField="上左工輥" HeaderText="上左工輥" SortExpression="上左工輥" />
                <asp:BoundField DataField="上工輥" HeaderText="上工輥" SortExpression="上工輥" />
                <asp:BoundField DataField="上右工輥" HeaderText="上右工輥" SortExpression="上右工輥" />
                <asp:BoundField DataField="下左工輥" HeaderText="下左工輥" SortExpression="下左工輥" />
                <asp:BoundField DataField="下工輥" HeaderText="下工輥" SortExpression="下工輥" />
                <asp:BoundField DataField="下右工輥" HeaderText="下右工輥" SortExpression="下右工輥" />
                <asp:BoundField DataField="頭尾鑿痕" HeaderText="頭尾鑿痕" SortExpression="頭尾鑿痕" />
                <asp:BoundField DataField="片偏" HeaderText="片偏" SortExpression="片偏" />
                <asp:BoundField DataField="剝片程度" HeaderText="剝片程度" SortExpression="剝片程度" />
                <asp:BoundField DataField="邊緣狀況" HeaderText="邊緣狀況" SortExpression="邊緣狀況" />
                <asp:BoundField DataField="油色澤" HeaderText="油色澤" SortExpression="油色澤" />
                <asp:BoundField DataField="是否再生" HeaderText="是否再生" SortExpression="是否再生" />
                <asp:BoundField DataField="油壓" HeaderText="油壓" SortExpression="油壓" />
            </Columns>
        </asp:GridView>
        <asp:ObjectDataSource ID="odsSearchResult3" runat="server" 
            SelectMethod="Search3" TypeName="QualityControl.CoilDefectSearch">
            <SelectParameters>
                <asp:ControlParameter ControlID="hfSQLString" Name="SQLString" 
                    PropertyName="Value" Type="String" />
                <asp:ControlParameter ControlID="hfDFAndMD30Range" Name="DFAndMD30Range" 
    ...
    <asp:View ID="View5" runat="server">
        <asp:Button ID="Button1" runat="server" Text="返回查詢頁面" Width="108px" />
        <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" 
            DataSourceID="odsSearchResult4" EnableModelValidation="True" 
            EnableViewState="False" Width="4200px">
            <Columns>
                <asp:BoundField DataField="序號" HeaderText="序號" SortExpression="序號" />
                <asp:BoundField DataField="鋼捲號碼" HeaderText="鋼捲號碼" SortExpression="鋼捲號碼" />
        ...
        <asp:ObjectDataSource ID="odsSearchResult4" runat="server" 
            SelectMethod="Search4" TypeName="QualityControl.CoilDefectSearch">
            <SelectParameters>
                <asp:ControlParameter ControlID="hfSQLString" Name="SQLString" 
                    PropertyName="Value" Type="String" />
                <asp:ControlParameter ControlID="hfDFAndMD30Range" Name="DFAndMD30Range" 
