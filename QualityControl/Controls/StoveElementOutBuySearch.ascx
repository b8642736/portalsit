<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="StoveElementOutBuySearch.ascx.vb" Inherits="QualityControl.StoveElementOutBuySearch" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="odsSearchResult" EnableModelValidation="True">
    <Columns>
        ...
        <asp:ObjectDataSource ID="odsSearchResult" runat="server" SelectMethod="Search" 
            TypeName="QualityControl.StoveElementOutBuySearch">
            <SelectParameters>
                <asp:ControlParameter ControlID="hfSQLString" Name="SQLString" 
                    PropertyName="Value" Type="String" />
                <asp:ControlParameter ControlID="hfDFAndMD30Range" Name="DFAndMD30Range" PropertyName="Value" Type="String" />
            </SelectParameters>
