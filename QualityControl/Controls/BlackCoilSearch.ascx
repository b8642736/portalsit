<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="BlackCoilSearch.ascx.vb" Inherits="QualityControl.BlackCoilSearch" %>
<style type="text/css">
    .style1 {
        width: 101px;
    }
...
<table style="width: 100%;">
    ...
    <tr>
        <td class="style1">
            <asp:CheckBox ID="chGAUGE" runat="server" Text="厚度" /></td>
        <td>

            <asp:TextBox ID="tbGAUGE_S" runat="server" Width="60px" />
            <asp:Label ID="lbGAUGE" runat="server" Text=" ~ " />
            <asp:TextBox ID="tbGAUGE_E" runat="server" Width="60px" />
        </td>
    </tr>
    <tr>
        <td class="style1">
            <asp:CheckBox ID="chWIDTH" runat="server" Text="寬度" /></td>
        <td>

            <asp:TextBox ID="tbWIDTH_S" runat="server" Width="60px" />
            <asp:Label ID="lbWIDTH" runat="server" Text=" ~ " />
            <asp:TextBox ID="tbWIDTH_E" runat="server" Width="60px" />
        </td>
    </tr>
    <tr>
        <td class="style1">鋼胚區間:</td>
        <td>
            <asp:CheckBox ID="chBlackCoilRangeA" runat="server" Text="頭塊(1010)" />
            &nbsp&nbsp&nbsp&nbsp<asp:CheckBox ID="chBlackCoilRangeB" runat="server" Text="中間塊" />
            &nbsp&nbsp&nbsp&nbsp<asp:CheckBox ID="chBlackCoilRangeC" runat="server" Text="尾塊(000)" />
...
<asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
    <asp:View ID="View1" runat="server">
        ...
        <asp:ObjectDataSource ID="odsSearchResult" runat="server" SelectMethod="Search"
            TypeName="QualityControl.BlackCoilSearch">
            <SelectParameters>
    ...
    <asp:View ID="View2" runat="server">
        <asp:GridView ID="GridView2" runat="server" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="中鋼重捲" HeaderText="中鋼重捲" SortExpression="中鋼重捲" />
        ...
        <asp:ObjectDataSource ID="odsSearchResult1" runat="server"
            SelectMethod="Search1" TypeName="QualityControl.BlackCoilSearch">
            <SelectParameters>
