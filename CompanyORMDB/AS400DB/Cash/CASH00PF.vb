Namespace CASH
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class CASH00PF
        Inherits ClassDBAS400
        Dim AS400DC As New AS400DateConverter

        Sub New()
            MyBase.New("CASH", GetType(CASH05PF).Name)
        End Sub
...
#End Region
#Region "受款人代碼  屬性:RECENO"

        Private _RECENO As String
        ''' <summary>
        ''' 受款人代碼
        ''' </summary>
        ''' <value></value>
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property RECENO() As String
            Get
                Return _RECENO
            End Get
            Set(ByVal value As String)
...
#End Region
#Region "單位中文說明 屬性:PARTNM"

        Private _PARTNM As String
        ''' <summary>
        ''' 單位中文說明
        ''' </summary>
        ''' <value></value>
...
#End Region
#Region "支出科目中文說明 屬性:ITMNM"

        Private _ITMNM As String
...
#End Region
#Region "用途代碼 屬性:USEITM"

        Private _USEITM As String
        ''' <summary>
        ''' 用途代碼
        ''' </summary>
        ''' <value></value>
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property USEITM() As String
            Get
                Return _USEITM
            End Get
            Set(ByVal value As String)
