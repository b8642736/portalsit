...
Public Class FODM01PF
	...
	Sub New()
		MyBase.New("TESTKUKU", GetType(FODM01PF).Name)
	End Sub

        '#Region "編號 屬性:FD001 - 改寫，設定值時多去呼叫queryPQDM03PF"
...
#Region "實付 屬性:FDTNP"
	...
	End Property
#End Region
#Region "民國年月 屬性:FDEEEMM - 改寫，設定值時多去呼叫queryPQDM03PF"
...
#Region "出勤資訊"
        ...
        Public Sub queryPQDM03PF()
            ...
            Dim queryEEEMM As Integer = Me.FDEEEMM
