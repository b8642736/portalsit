Namespace SQLServer
    Namespace QCDB01
        Public Class LabRecordA2_Remark_RESAssay
...
#Region "ASSAY_ID 屬性:ASSAY_ID"
            ...
            End Property
#End Region
#Region "JUDGET_TYPE 屬性:JUDGET_TYPE"
            Private _JUDGET_TYPE As System.String
            ''' <summary>
            ''' JUDGET_TYPE
            ''' </summary>
            ''' <returns></returns>
            ''' <remarks></remarks>
            Public Property JUDGET_TYPE() As System.String
                Get
                    Return _JUDGET_TYPE
                End Get
                Set(ByVal value As System.String)
            ...
            End Property
#End Region
#Region "JUDGET_DOC 屬性:JUDGET_DOC"
            Private _JUDGET_DOC As System.String
            ''' <summary>
            ''' JUDGET_DOC
            ''' </summary>
            ''' <returns></returns>
            ''' <remarks></remarks>
            Public Property JUDGET_DOC() As System.String
                Get
                    Return _JUDGET_DOC
                End Get
                Set(ByVal value As System.String)
