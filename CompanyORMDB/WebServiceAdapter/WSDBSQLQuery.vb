Namespace Portalsit2
    Partial Public Class WSDBSQLQuery
        ...
        Public Function SQLServerSelectQueryGo(ByVal SetSourceQueryString As String, ByVal SetSQLServerConnectionString As String, ByVal AcceptCodeReplay As String) As System.Data.DataTable Implements IWSDBSQLQuery.SQLServerSelectQueryGo
            Return Me.SQLServerSelectQuery(SetSourceQueryString, SetSQLServerConnectionString, AcceptCodeReplay)
        End Function

        Public Function SQLServerExecuteNonQueryGo(ByVal SetSourceQueryString As String, ByVal SetSQLServerConnectionString As String, ByVal AcceptCodeReplay As String) As Integer Implements IWSDBSQLQuery.SQLServerExecuteNonQueryGo
            Return Me.SQLServerExecuteNonQuery(SetSourceQueryString, SetSQLServerConnectionString, AcceptCodeReplay)
        End Function
