<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="OrderMonthAnalysisControl.ascx.vb" Inherits="Business.OrderMonthAnalysisControl" %>
...
<rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
    ...
    <LocalReport ReportPath="Controls\OrderMonthAnalysis\OrderMonthAnalysisReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="odsSearchResult" 
                Name="SLS300LB_OrderMonthAnalysisPrint" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer>
<asp:ObjectDataSource ID="odsSearchResult" runat="server" SelectMethod="Search" 
    TypeName="Business.OrderMonthAnalysisControl">
    <SelectParameters>
