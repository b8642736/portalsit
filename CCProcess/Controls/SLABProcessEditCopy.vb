Public Class SLABProcessEditCopy
...
#End Region
    ...
    Private Sub SLABProcessEdit_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        TabPage1.Controls.Add(Me.SLABProcessEdit_TemperatureWeightViewControl) : Me.SLABProcessEdit_TemperatureWeightViewControl.Dock = DockStyle.Fill
        Me.SLABProcessEdit_TemperatureWeightViewControl.TitleControl = Me
        TabPage2.Controls.Add(Me.SLABProcessEdit_SteelTrouthTemperatureControl) : Me.SLABProcessEdit_SteelTrouthTemperatureControl.Dock = DockStyle.Fill
        Me.SLABProcessEdit_SteelTrouthTemperatureControl.TitleControl = Me
        TabPage3.Controls.Add(Me.SLABProcessEdit_SLABProcessEditCastProcessControl) : Me.SLABProcessEdit_SLABProcessEditCastProcessControl.Dock = DockStyle.Fill
        Me.SLABProcessEdit_SLABProcessEditCastProcessControl.TitleControl = Me
        TabPage4.Controls.Add(Me.SLABProcessEdit_SLABProcessEditModuleCondictionControl) : Me.SLABProcessEdit_SLABProcessEditModuleCondictionControl.Dock = DockStyle.Fill
        Me.SLABProcessEdit_SLABProcessEditModuleCondictionControl.TitleControl = Me
        TabPage5.Controls.Add(Me.SLABProcessEdit_SLABProcessEditTroughAndPipeControl) : Me.SLABProcessEdit_SLABProcessEditTroughAndPipeControl.Dock = DockStyle.Fill
        Me.SLABProcessEdit_SLABProcessEditTroughAndPipeControl.TitleControl = Me
        TabPage6.Controls.Add(Me.SLABProcessEdit_ModelWaterTemperatureControl) : Me.SLABProcessEdit_ModelWaterTemperatureControl.Dock = DockStyle.Fill
        Me.SLABProcessEdit_ModelWaterTemperatureControl.TitleControl = Me
        TabPage7.Controls.Add(Me.SLABProcessEdit_SLABProcessEditSecondColdWaterControl) : Me.SLABProcessEdit_SLABProcessEditSecondColdWaterControl.Dock = DockStyle.Fill
        Me.SLABProcessEdit_SLABProcessEditSecondColdWaterControl.TitleControl = Me
        TabPage8.Controls.Add(Me.SLABProcessEdit_SLABProcessEdit_ElementsInfoControl) : Me.SLABProcessEdit_SLABProcessEdit_ElementsInfoControl.Dock = DockStyle.Fill
