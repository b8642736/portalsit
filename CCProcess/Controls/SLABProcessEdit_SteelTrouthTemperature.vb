Public Class SLABProcessEdit_SteelTrouthTemperature
...
#End Region
    ...
    Private Sub TitleControlEvent_DataPositionChanged(sender As Object, e As System.EventArgs) Handles TitleControlEvent.DataPositionChanged
        If IsNothing(CurrentEditSMSC2PF) Then
            ...
            Me.Enabled = False
        Else
            Me.bsSMSC21PF.DataSource = CurrentEditSMSC2PF.AboutSMSC21PFs
            Me.Enabled = True
        End If
        Me.bsSMSC21PF.ResetBindings(False)
    End Sub

    Private Sub bsSMSC21PF_AddingNew(sender As Object, e As System.ComponentModel.AddingNewEventArgs) Handles bsSMSC21PF.AddingNew
    ...
    Private Sub BindingNavigatorDeleteItem_Click(sender As System.Object, e As System.EventArgs) Handles BindingNavigatorDeleteItem.Click
        ...
        Else
            ...
            If Not IsNothing(CurrentRowObject) Then
                ...
                Me.TitleControl.CurrentEditSMSC2PF.AboutSMSC21PFs.Remove(CurrentRowObject)
                Me.bsSMSC21PF.ResetBindings(False)
            End If
        End If
