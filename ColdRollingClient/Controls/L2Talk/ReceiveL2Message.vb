Public Class ReceiveL2Message
    ...
    Public Event FileChangedEvent(sender As Object, e As IO.FileSystemEventArgs, L2Messages As L2Message)
...
#Region "傳送監看檔案變更事件 函式:SendWatchFileChangedEvent"
    ...
    Sub SendWatchFileChangedEvent(sender As Object, e As IO.FileSystemEventArgs)
        Static PreEventFirstRowData As L2Message = Nothing
        ...
        Dim GetL2Message As L2Message = Nothing
        ...
        End If
        Try
            GetL2Message = New L2Message(ReadDatas(0))
        Catch ex As Exception
            ...
            Exit Sub
        End Try
        If Not IsNothing(PreEventFirstRowData) AndAlso PreEventFirstRowData.HappenTime = GetL2Message.HappenTime Then
            Exit Sub
        End If
