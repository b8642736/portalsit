    ...
    ReadOnly Property TheStationCanUseBugDefines(Optional IsUpLineBug As Boolean = False) As List(Of QABUG)
        Get
            ...
            If Not IsNothing(_TempDatas) AndAlso _TempDatas.Count > 0 Then
                If IsUpLineBug Then
                    _TheStationCanUseBugDefines = (From A In _TempDatas Where A.SBLUseSortUpLineNumber > 0 Order By A.TLLUseSortUpLineNumber Select A).ToList
                Else
                    _TheStationCanUseBugDefines = (From A In _TempDatas Where A.SBLUseSortNumber > 0 Order By A.TLLUseSortNumber Select A).ToList
                End If
            Else
