<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="FoodMonthReport_Detail.ascx.vb" Inherits="Personnel.FoodMonthReport_Detail" %>
...
<table class="auto-style1">
    ...
    <tr>
        <td class="auto-style2">身分別：</td>
        <td class="auto-style3">
            <asp:DropDownList ID="ddPeopleKind" runat="server" Height="30px" Width="150px" />
        </td>
    </tr>
    <tr>
...
<rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="12pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%" Height="500px">
    <LocalReport ReportPath="bin\Controls\FoodMonthReport_Detail\FoodMonthReport_DetailReport.rdlc" ReportEmbeddedResource="Personnel.FoodMonthReport_DetailReport.rdlc">
        <DataSources>
