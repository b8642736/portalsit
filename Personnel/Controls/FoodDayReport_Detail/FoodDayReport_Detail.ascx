<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="FoodDayReport_Detail.ascx.vb" Inherits="Personnel.FoodDayReport_Detail" %>
...
<rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="12pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%" Height="500px">
    <LocalReport  ReportPath="bin\Controls\FoodDayReport_Detail\FoodDayReport_DetailReport.rdlc">
        <DataSources>
