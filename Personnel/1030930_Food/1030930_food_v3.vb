<asp:ListView ID="ListView1" runat="server" EnableModelValidation="True" DataKeyNames="FD001" DataSourceID="odsSearchResult">
                <AlternatingItemTemplate>
                    <tr style="background-color: #FFF8DC;">
                        ...
                        <td>
                            ...
                            <asp:Label ID="FD01CLabel" runat="server" Text='<%# showFoodType(Eval("FD01C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD02CLabel" runat="server" Text='<%# showFoodType(Eval("FD02C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD03CLabel" runat="server" Text='<%# showFoodType(Eval("FD03C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD04CLabel" runat="server" Text='<%# showFoodType(Eval("FD04C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD05CLabel" runat="server" Text='<%# showFoodType(Eval("FD05C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD06CLabel" runat="server" Text='<%# showFoodType(Eval("FD06C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD07CLabel" runat="server" Text='<%# showFoodType(Eval("FD07C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD08CLabel" runat="server" Text='<%# showFoodType(Eval("FD08C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD09CLabel" runat="server" Text='<%# showFoodType(Eval("FD09C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD10CLabel" runat="server" Text='<%# showFoodType(Eval("FD10C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD11CLabel" runat="server" Text='<%# showFoodType(Eval("FD11C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD12CLabel" runat="server" Text='<%# showFoodType(Eval("FD12C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD13CLabel" runat="server" Text='<%# showFoodType(Eval("FD13C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD14CLabel" runat="server" Text='<%# showFoodType(Eval("FD14C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD15CLabel" runat="server" Text='<%# showFoodType(Eval("FD15C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD16CLabel" runat="server" Text='<%# showFoodType(Eval("FD16C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD17CLabel" runat="server" Text='<%# showFoodType(Eval("FD17C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD18CLabel" runat="server" Text='<%# showFoodType(Eval("FD18C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD19CLabel" runat="server" Text='<%# showFoodType(Eval("FD19C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD20CLabel" runat="server" Text='<%# showFoodType(Eval("FD20C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD21CLabel" runat="server" Text='<%# showFoodType(Eval("FD21C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD22CLabel" runat="server" Text='<%# showFoodType(Eval("FD22C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD23CLabel" runat="server" Text='<%# showFoodType(Eval("FD23C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD24CLabel" runat="server" Text='<%# showFoodType(Eval("FD24C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD25CLabel" runat="server" Text='<%# showFoodType(Eval("FD25C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD26CLabel" runat="server" Text='<%# showFoodType(Eval("FD26C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD27CLabel" runat="server" Text='<%# showFoodType(Eval("FD27C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD28CLabel" runat="server" Text='<%# showFoodType(Eval("FD28C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD29CLabel" runat="server" Text='<%# showFoodType(Eval("FD29C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD30CLabel" runat="server" Text='<%# showFoodType(Eval("FD30C")) %>' />
                        </td>
                        <td>
                            ...
                            <asp:Label ID="FD31CLabel" runat="server" Text='<%# showFoodType(Eval("FD31C")) %>' />
                        </td>
                ...
                <EditItemTemplate>
                    <tr style="background-color: #008A8C; color: #FFFFFF;">
                        ...
                        <td>
                            <asp:Label ID="FD01Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別01"), Eval("出勤時間01"))%>' /><br>
                            <asp:TextBox ID="FD01BTextBox" runat="server" Text='<%# Eval("FD01B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD01CTextBox" runat="server" Text='<%# Eval("FD01C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD01B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD01C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD02Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別02"), Eval("出勤時間02"))%>' /><br>
                            <asp:TextBox ID="FD02BTextBox" runat="server" Text='<%# Eval("FD02B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD02CTextBox" runat="server" Text='<%# Eval("FD02C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD02B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD02C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD03Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別03"), Eval("出勤時間03"))%>' /><br>
                            <asp:TextBox ID="FD03BTextBox" runat="server" Text='<%# Eval("FD03B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD03CTextBox" runat="server" Text='<%# Eval("FD03C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD03B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD03C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD04Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別04"), Eval("出勤時間04"))%>' /><br>
                            <asp:TextBox ID="FD04BTextBox" runat="server" Text='<%# Eval("FD04B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD04CTextBox" runat="server" Text='<%# Eval("FD04C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD04B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD04C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD05Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別05"), Eval("出勤時間05"))%>' /><br>
                            <asp:TextBox ID="FD05BTextBox" runat="server" Text='<%# Eval("FD05B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD05CTextBox" runat="server" Text='<%# Eval("FD05C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD05B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD05C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD06Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別06"), Eval("出勤時間06"))%>' /><br>
                            <asp:TextBox ID="FD06BTextBox" runat="server" Text='<%# Eval("FD06B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD06CTextBox" runat="server" Text='<%# Eval("FD06C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD06B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD06C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD07Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別07"), Eval("出勤時間07"))%>' /><br>
                            <asp:TextBox ID="FD07BTextBox" runat="server" Text='<%# Eval("FD07B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD07CTextBox" runat="server" Text='<%# Eval("FD07C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD07B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD07C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD08Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別08"), Eval("出勤時間08"))%>' /><br>
                            <asp:TextBox ID="FD08BTextBox" runat="server" Text='<%# Eval("FD08B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD08CTextBox" runat="server" Text='<%# Eval("FD08C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD08B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD08C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD09Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別09"), Eval("出勤時間09"))%>' /><br>
                            <asp:TextBox ID="FD09BTextBox" runat="server" Text='<%# Eval("FD09B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD09CTextBox" runat="server" Text='<%# Eval("FD09C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD09B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD09C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD10Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別10"), Eval("出勤時間10"))%>' /><br>
                            <asp:TextBox ID="FD10BTextBox" runat="server" Text='<%# Eval("FD10B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD10CTextBox" runat="server" Text='<%# Eval("FD10C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD10B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD10C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD11Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別11"), Eval("出勤時間11"))%>' /><br>
                            <asp:TextBox ID="FD11BTextBox" runat="server" Text='<%# Eval("FD11B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD11CTextBox" runat="server" Text='<%# Eval("FD11C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD11B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD11C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD12Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別12"), Eval("出勤時間12"))%>' /><br>
                            <asp:TextBox ID="FD12BTextBox" runat="server" Text='<%# Eval("FD12B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD12CTextBox" runat="server" Text='<%# Eval("FD12C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD12B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD12C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD13Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別13"), Eval("出勤時間13"))%>' /><br>
                            <asp:TextBox ID="FD13BTextBox" runat="server" Text='<%# Eval("FD13B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD13CTextBox" runat="server" Text='<%# Eval("FD13C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD13B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD13C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD14Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別14"), Eval("出勤時間14"))%>' /><br>
                            <asp:TextBox ID="FD14BTextBox" runat="server" Text='<%# Eval("FD14B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD14CTextBox" runat="server" Text='<%# Eval("FD14C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD14B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD14C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD15Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別15"), Eval("出勤時間15"))%>' /><br>
                            <asp:TextBox ID="FD15BTextBox" runat="server" Text='<%# Eval("FD15B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD15CTextBox" runat="server" Text='<%# Eval("FD15C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD15B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD15C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD16Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別16"), Eval("出勤時間16"))%>' /><br>
                            <asp:TextBox ID="FD16BTextBox" runat="server" Text='<%# Eval("FD16B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD16CTextBox" runat="server" Text='<%# Eval("FD16C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD16B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD16C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD17Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別17"), Eval("出勤時間17"))%>' /><br>
                            <asp:TextBox ID="FD17BTextBox" runat="server" Text='<%# Eval("FD17B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD17CTextBox" runat="server" Text='<%# Eval("FD17C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD17B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD17C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD18Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別18"), Eval("出勤時間18"))%>' /><br>
                            <asp:TextBox ID="FD18BTextBox" runat="server" Text='<%# Eval("FD18B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD18CTextBox" runat="server" Text='<%# Eval("FD18C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD18B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD18C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD19Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別19"), Eval("出勤時間19"))%>' /><br>
                            <asp:TextBox ID="FD19BTextBox" runat="server" Text='<%# Eval("FD19B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD19CTextBox" runat="server" Text='<%# Eval("FD19C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD19B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD19C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD20Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別20"), Eval("出勤時間20"))%>' /><br>
                            <asp:TextBox ID="FD20BTextBox" runat="server" Text='<%# Eval("FD20B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD20CTextBox" runat="server" Text='<%# Eval("FD20C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD20B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD20C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD21Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別21"), Eval("出勤時間21"))%>' /><br>
                            <asp:TextBox ID="FD21BTextBox" runat="server" Text='<%# Eval("FD21B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD21CTextBox" runat="server" Text='<%# Eval("FD21C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD21B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD21C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD22Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別22"), Eval("出勤時間22"))%>' /><br>
                            <asp:TextBox ID="FD22BTextBox" runat="server" Text='<%# Eval("FD22B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD22CTextBox" runat="server" Text='<%# Eval("FD22C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD22B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD22C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD23Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別23"), Eval("出勤時間23"))%>' /><br>
                            <asp:TextBox ID="FD23BTextBox" runat="server" Text='<%# Eval("FD23B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD23CTextBox" runat="server" Text='<%# Eval("FD23C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD23B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD23C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD24Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別24"), Eval("出勤時間24"))%>' /><br>
                            <asp:TextBox ID="FD24BTextBox" runat="server" Text='<%# Eval("FD24B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD24CTextBox" runat="server" Text='<%# Eval("FD24C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD24B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD24C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD25Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別25"), Eval("出勤時間25"))%>' /><br>
                            <asp:TextBox ID="FD25BTextBox" runat="server" Text='<%# Eval("FD25B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD25CTextBox" runat="server" Text='<%# Eval("FD25C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD25B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD25C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD26Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別26"), Eval("出勤時間26"))%>' /><br>
                            <asp:TextBox ID="FD26BTextBox" runat="server" Text='<%# Eval("FD26B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD26CTextBox" runat="server" Text='<%# Eval("FD26C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD26B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD26C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD27Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別27"), Eval("出勤時間27"))%>' /><br>
                            <asp:TextBox ID="FD27BTextBox" runat="server" Text='<%# Eval("FD27B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD27CTextBox" runat="server" Text='<%# Eval("FD27C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD27B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD27C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD28Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別28"), Eval("出勤時間28"))%>' /><br>
                            <asp:TextBox ID="FD28BTextBox" runat="server" Text='<%# Eval("FD28B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD28CTextBox" runat="server" Text='<%# Eval("FD28C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD28B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD28C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD29Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別29"), Eval("出勤時間29"))%>' /><br>
                            <asp:TextBox ID="FD29BTextBox" runat="server" Text='<%# Eval("FD29B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD29CTextBox" runat="server" Text='<%# Eval("FD29C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD29B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD29C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD30Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別30"), Eval("出勤時間30"))%>' /><br>
                            <asp:TextBox ID="FD30BTextBox" runat="server" Text='<%# Eval("FD30B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD30CTextBox" runat="server" Text='<%# Eval("FD30C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD30B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD30C" runat="server"/><br>
                        </td>
                        <td>
                            <asp:Label ID="FD31Label" runat="server" Text='<%# show出勤資料(Eval("出勤班別31"), Eval("出勤時間31"))%>' /><br>
                            <asp:TextBox ID="FD31BTextBox" runat="server" Text='<%# Eval("FD31B") %>'  Visible="false" /><br>
                            <asp:TextBox ID="FD31CTextBox" runat="server" Text='<%# Eval("FD31C") %>'  Visible="false" />
                            <asp:DropDownList ID="ddFD31B" runat="server"/><br>
                            <asp:DropDownList ID="ddFD31C" runat="server"/><br>
                        </td>
