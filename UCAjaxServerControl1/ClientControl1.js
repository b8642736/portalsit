...
Type.registerNamespace("UCAjaxServerControl1");

UCAjaxServerControl1.ClientControl1 = function(element) {
    UCAjaxServerControl1.ClientControl1.initializeBase(this, [element]);
}

UCAjaxServerControl1.ClientControl1.prototype = {
    initialize: function() {
        UCAjaxServerControl1.ClientControl1.callBaseMethod(this, 'initialize');
        
        // 在此加入自訂初始設定
    },
    dispose: function() {        
        //在此加入自訂處置動作
        UCAjaxServerControl1.ClientControl1.callBaseMethod(this, 'dispose');
    }
}
UCAjaxServerControl1.ClientControl1.registerClass('UCAjaxServerControl1.ClientControl1', Sys.UI.Control);
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFHJleU2CRLAV
// SIG // HZf7+Wek31uuBbPMoIISMTCCBGAwggNMoAMCAQICCi6r
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSKBOVAuxRm
// SIG // kC9gkmQpsRMPSiJQuzBOBgorBgEEAYI3AgEMMUAwPqAk
// SIG // gCIAQwBsAGkAZQBuAHQAQwBvAG4AdAByAG8AbAAxAC4A
// SIG // agBzoRaAFGh0dHA6Ly9taWNyb3NvZnQuY29tMA0GCSqG
// SIG // SIb3DQEBAQUABIIBAIIlHLzAlLnhTgGVp3mrQwOCDkHR
// SIG // 7qDbVj7fjSGVfjVUb4z7VyAWZS4IbIrw4TDATZlvgnyl
// SIG // OBsW1CaCNT+JbNpr6S5RJrvoscQyKSZHEdCdPWxHTZfI
// SIG // ib3hkoxIcXGjJ2PnvPhzKw5GKJ9Ggi7DohzwI5mhxKpx
// SIG // W23TCqUCRV79xWvbNqGuS7q51OZik15sQPwznczU6ALM
// SIG // 3zFRYmQ6v9t7zC4UbJKQ7NEgkhEuONIcJcenTtESAMZP
// SIG // ygNEH/Bc3XAdCn47N9k6l3bFygIgPcIGD/tshgMwI7es
// SIG // 0ACp0wDCEKtr74hIM3M2zxl8EyvyCcjUtNBkoZhiKuih
// SIG // t/Pb1YyhggIfMIICGwYJKoZIhvcNAQkGMYICDDCCAggC
...
// SIG // MDQxNDAwMTRaMCMGCSqGSIb3DQEJBDEWBBQ1v56LqIt7
// SIG // Zjy09URfUzGe+2jGjjANBgkqhkiG9w0BAQUFAASCAQAN
// SIG // GkK27xBLfJdPPkWELu5NJanBbAXERKs1ey0wNNeZFSRp
// SIG // 1ApR18cayXJKA7eePdwM26bj70i1UJB/wI0nV8soMcjt
// SIG // deNpnS++iAMpamoWKhOw1jUom4grMITd4Nt1aj1IMS82
// SIG // WwOOEsIg4v9PXcAF0qBXndVH7i+h9A37rFZWeO5TxGz9
// SIG // gld0Mmu+ezBvp+56LyyaYcUvQOy1oNa+QXUXVG8CYENe
// SIG // HksMzAR1OxXOnhksTfcyTUSltoB1tdknfX4fd1BHoQn/
// SIG // fVI2YmIm1B8KoGpFabBAybaqbbFz1w4xoUfd5DCL7kbk
// SIG // gXrGfaaaQRRh8YArRKlmVbJEzhv0OMe0
