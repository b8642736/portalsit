<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EmployeeSampleSearch.ascx.vb" Inherits="Business.EmployeeSampleSearch" %>
<style type="text/css">
    .style1
    {
        width: 133px;
...
<asp:ObjectDataSource ID="odsSearchResult" runat="server" SelectMethod="Search" 
    TypeName="Business.EmployeeSampleSearch">
    <SelectParameters>
