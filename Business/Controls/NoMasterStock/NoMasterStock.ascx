...
<table style="width:100%;">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="tbSteelKind" runat="server" Width="230px"></asp:TextBox>
            (兩個以上以 &#39;,&#39; 分隔) </td>
    </tr>
    <tr>
        <td class="style1">表面:</td>
        <td>
            <asp:TextBox ID="tbSteelFace" runat="server" Width="230px"></asp:TextBox>
            (兩個以上以 &#39;,&#39; 分隔) </td>
    </tr>
    <tr>
        <td class="style1">等級:</td>
        <td>
            <asp:TextBox ID="tbLevel" runat="server" Width="96px"></asp:TextBox>
            (兩個以上以 &#39;,&#39; 分隔) </td>
    </tr>
    <tr>
        <td class="style1">
